...
description: >-
  Introduction to essential Vastu terminology including Brahmasthan, Marma
  points, Pada Vinyasa, Aayadi calculations, and other fundamental concepts
  necessary for understanding the language and practice of Vastu Shastra.
pubDate: '2025-05-08'
keywords:
  - Vastu
  - Terminology
...
<AIBlufSummary>
Vastu Shastra: The Ancient Science of Architecture by Dr. Jessie Mercay Mayamata: Indian Treatise on Housing Architecture and Iconography translated by Bruno Dagens Vastu Vidya: The Indian Tradition of Architecture and Design by Claude Bätzner The Vastu Workbook: Using the Subtle Energies of the Indian Art of Placement by Talavane Krishna
</AIBlufSummary>
...
<AIBlufSummary>
Vastu calculations begin with the creation of a proper grid system (Pada Vinyasa) based on the plot's dimensions. The plot is ideally square in shape, divided into 9 smaller squares forming a specific grid, with each square indicating the particular function of the space in relation to the four primary directions: North, East, West, and South[2]. The calculation process involves: Determining the exact cardinal directions using a compass Establishing the center point (Brahmasthan) Dividing the plot according to the appropriate Pada Vinyasa grid Calculating Aayadi formulas, which include: Aaya (income): Determines the financial prosperity associated with the building Vyaya (expenditure): Indicates potential financial outflow Yoni (source): Relates to compatibility and harmony Tithi (lunar day): Connects the building to cosmic rhythms Nakshatra (constellation): Aligns the structure with stellar influences These calculations help determine the auspiciousness of a plot and guide modifications needed to optimize energy flow.
</AIBlufSummary>
...
<AIBlufSummary>
When interpreting Vastu principles in a space, several key guidelines should be followed: Directional Significance: The northeast (Ishanya) is considered the most sacred direction and should be kept light and clean, while the southwest corner is ideal for the main structure of the building[2]. Element Association: Each direction corresponds to different elements—north with water, east with air, south with fire, west with earth, and the center with space. Rooms and functions should align with their elemental associations.
</AIBlufSummary>
...
<AIBlufSummary>
Example 1: Residential Brahmasthan Analysis In a 30×30 ft square house, the Brahmasthan would be the central 10×10 ft area. In an ideal Vastu-compliant home, this area should be kept open or used as a courtyard or central hall with minimal furniture. If the central area contains a bathroom, kitchen, or heavy storage, it creates energy blockages.
</AIBlufSummary>
