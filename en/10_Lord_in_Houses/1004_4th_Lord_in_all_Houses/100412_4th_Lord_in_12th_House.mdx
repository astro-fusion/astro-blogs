...
<KundaliChart
  title="4th Lord in 12th House — Illustrative Chart"
  combinationLabel="4th Lord in 12th House"
  lagnaRashi={1}
  placements={[
    { planet: "Moon", house: 12, isLordOf: 4 }
  ]}
  highlightHouses={[4, 12]}
  description="This illustrative chart (Aries Lagna) shows the 4th lord placed in the 12th house. For Aries Lagna, Moon rules the 4th house and is placed here in the 12th. Your actual 4th lord depends on your personal Lagna — calculate your Kundali for precise results."
  effects={[
    "The placement brings 4th-house themes into liberation, foreign life, solitude, and spiritual practice.",
    "The Moon's natural significations blend with the matters of the 12th house.",
...
<BookShlokaSnippet
  ...
  chapter={24}
  shloka={48}
  sanskrit="भावे 12 लग्नाधिपे जातो 4 भावेशफलैर्युतः। शुभदृष्ट्या विशेषेण सर्वकार्यार्थसिद्धिमान्॥"
  transliteration="bhāve 12 lagnādhipe jāto 4 bhāveśaphalairyutaḥ | śubhadṛṣṭyā viśeṣeṇa sarvakāryārthasiddhimān ||"
  ...
  learningHref="https://learning.astro-fusion.com/en/books/bphs/chapter-24#shloka-48"
  locale="en"
/>

<YogaDeepLink
  yogaId="HoroscopeDataListStatic:house4lordinhouse12"
  label="4th Lord in 12th House Sambandha Yoga — Classical Shastra Verification"
...
<AIBlufSummary>
The 4th Lord in 12th House creates a profound spiritual opportunity to transform human love into divine love, using family relationships as the classroom for learning unconditional compassion and ultimate surrender. This placement teaches that true security comes not from holding onto family but from loving so completely that you can let go with grace. Your journey involves learning to be a bridge between earthly love and heavenly love, showing others how family relationships can be spiritual practices that lead to liberation rather than bondage.
</AIBlufSummary>
...
<FAQBlock
  faqs={[
    { question: "What does 4th lord in 12th house mean?", answer: "It means the ruling planet of the 4th house is placed in the 12th house, connecting home, mother, property, and emotional security with liberation, foreign life, solitude, and spiritual practice. The exact result depends on the ascendant, planet, sign, dignity, aspects, and dasha." },
    { question: "Is 4th lord in 12th house good or bad?", answer: "It is not inherently good or bad. A strong and supported lord can express the constructive side of liberation, foreign life, solitude, and spiritual practice, while affliction may bring challenges in those areas." },
