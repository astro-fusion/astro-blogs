...
<AIBlufSummary>
The 2nd house represents our fundamental resources - money, possessions, values, speech, and family wealth. When its lord moves to the 11th house of gains, friends, networks, and collective achievements, it creates a natural flow of wealth through social connections and group activities. This placement suggests that the native's financial prosperity is largely dependent on their ability to build and maintain networks, collaborate with others, and participate in group endeavors.
</AIBlufSummary>
<KundaliChart
  title="2nd Lord in 11th House — Illustrative Chart"
  combinationLabel="2nd Lord in 11th House"
  lagnaRashi={1}
  placements={[
    { planet: "Venus", house: 11, isLordOf: 2 }
  ]}
  highlightHouses={[2, 11]}
  description="This illustrative chart (Aries Lagna) shows the 2nd lord placed in the 11th house. For Aries Lagna, Venus rules the 2nd house and is placed here in the 11th. Your actual 2nd lord depends on your personal Lagna — calculate your Kundali for precise results."
  effects={[
    "The placement brings 2nd-house themes into gains, networks, friendships, and aspirations.",
    "The planet's natural significations blend with the matters of the 11th house.",
...
<BookShlokaSnippet
  ...
  transliteration="lābhe dhaneśvare jāto dhanalābhasamanvitaḥ | nityaṁ lābho bhavettasya sarvakāryeṣu siddhimān ||"
  ...
  learningHref="https://learning.astro-fusion.com/en/books/bphs/chapter-24#shloka-23"
  locale="en"
/>

<YogaDeepLink
  yogaId="HoroscopeDataListStatic:house2lordinhouse11"
  label="Param Dhana Labha Yoga — Classical Shastra Verification"
...
<FAQBlock
  faqs={[
    { question: "What does 2nd lord in 11th house mean?", answer: "It means the ruling planet of the 2nd house is placed in the 11th house, connecting gains, networks, friendships, and aspirations. The exact result depends on the ascendant, planet, sign, dignity, aspects, and dasha." },
    { question: "Is 2nd lord in 11th house good or bad?", answer: "It is not inherently good or bad. A strong and supported lord can express the constructive side of gains, networks, friendships, and aspirations, while affliction may bring challenges in those areas." },
...
- [11th Lord in 2nd House](/blogs/10_Lord_in_Houses/1011_11th_Lord_in_all_Houses/1011_11th_Lord_in_all_Houses/101102_1st_Lord_in_2nd_House)
