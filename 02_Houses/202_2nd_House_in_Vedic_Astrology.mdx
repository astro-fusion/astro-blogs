...
<FAQBlock faqs={[
  ...
  { "question": "How can I tell if I will be wealthy based on my 2nd House?", "answer": "A strong 2nd House Lord, or the presence of benefics like Jupiter or Venus, generally indicates the capacity to accumulate and retain significant wealth." },
  { "question": "How does the 2nd House influence speech?", "answer": "It governs the mouth and voice. Mercury here makes one articulate, while Venus adds sweetness to the voice. Malefics can cause harsh speech or impediments." },
  { "question": "What is the relationship between the 2nd House and family?", "answer": "It represents the family you are born into, your upbringing, and the cultural or moral values inherited from your lineage." },
  { "question": "Why is the 2nd House sometimes called a 'Maraka' house?", "answer": "In astrological theory, the 2nd and 7th houses are 'death-inflicting' (Maraka) because they represent the points where the soul's attachment to the material world can lead to physical exhaustion." },
  { "question": "What kind of food habits are indicated by the 2nd House?", "answer": "The sign and planets in the 2nd House indicate your dietary preferences (e.g., Mars for spicy food, Venus for sweets) and overall relationship with nutrition." },
  { "question": "What are common remedies for 2nd House financial issues?", "answer": "Typical remedies include worshipping Goddess Lakshmi, donating food to the needy, practicing mindful speech, and lighting a ghee lamp in the North-East corner of the home." }
]} />
