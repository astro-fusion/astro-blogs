...
<FAQBlock faqs={[
  { "question": "What is the primary significance of the 6th House in Vedic Astrology?", "answer": "The 6th House (Shatru Bhava) primarily deals with health, service (Seva), daily work routines, enemies, debts, and obstacles." },
  { "question": "How can the 6th House help in winning competitions?", "answer": "As an 'Upachaya' house, it governs the native's ability to overcome rivals and adversaries. A strong 6th house is essential for success in sports, law, and competitive exams." },
  { "question": "What is the role of Mars in the 6th House?", "answer": "Mars performs very well here, providing the native with the physical strength and courage needed to defeat enemies and overcome significant life hurdles." },
  { "question": "Does the 6th House indicate chronic diseases?", "answer": "It shows the nature of ailments one may face. While it can indicate chronic issues if afflicted, its primary focus is on the body's ability to fight off infections and heal." },
  { "question": "How does the 6th House influence daily work environment?", "answer": "It rules the conditions of your workplace, relationship with coworkers, and the discipline with which you approach your daily tasks." },
  { "question": "Does the 6th House affect legal litigation?", "answer": "Yes, it specifically signifies court cases, disputes with opponents, and the native's capacity to handle legal conflicts successfully." },
  { "question": "What are the common remedies to strengthen the 6th House?", "answer": "Effective remedies include selfless service (Seva), feeding birds or small animals, worshipping Lord Hanuman, and maintaining a strict, healthy lifestyle routine." }
]} />
