...
---
<FAQBlock faqs={[
  { "question": "What is the meaning of Aashvini Nakshatra?", "answer": "Aashvini Nakshatra is the first star in the Vedic zodiac, symbolizing new beginnings, speed, and divine healing. Its symbol is a horse's head." },
  { "question": "Which planet rules Ashwini Nakshatra?", "answer": "Aashvini Nakshatra is ruled by Ketu (the South Node of the Moon), adding a spiritual, sudden, and karmic dimension to individuals born under it." },
  { "question": "What are the common careers for Ashwini Nakshatra natives?", "answer": "Ashwini natives excel in healthcare, emergency medicine, sports, transportation, logistics, and any fast-paced entrepreneurial ventures that require immediate action." },
  { "question": "Who is the deity of Ashwini Nakshatra?", "answer": "The Ashwini Kumars, the twin physician gods in Vedic mythology, rule this Nakshatra. They bestow miraculous healing powers and vitality." },
  { "question": "What are the negative traits of Ashwini Nakshatra?", "answer": "Negative traits include impulsiveness, impatience, quick temper, a restless nature, and a tendency to abandon projects or relationships prematurely." }
]} />
