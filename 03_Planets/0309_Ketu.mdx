...
As the south node and shadow planet, Ketu does not own any zodiac sign in the traditional sense. However, its influence is particularly profound in signs where spiritual detachment and deep introspection are heightened:

#### Zodiac Signs and Ketu's Influence
- **Exaltation:** [Scorpio (Vrishchika)](../01_Rasi/0108_Vrishchika.mdx) or [Sagittarius (Dhanu)](../01_Rasi/0109_Dhanu.mdx) — Ketu reaches its peak of mystical depth in Scorpio and spiritual wisdom in Sagittarius.
- **Debilitation:** [Taurus (Vrishabha)](../01_Rasi/0102_Vrishabha.mdx) or [Gemini (Mithuna)](../01_Rasi/0103_Mithuna.mdx) — Ketu's detaching nature is challenged by the material stability of Taurus or the intellectual chatter of Gemini.
- **Friendly Signs:** Ketu generally aligns well with signs ruled by Mars ([Aries](../01_Rasi/0101_Mesha.mdx), [Scorpio](../01_Rasi/0108_Vrishchika.mdx)) and Jupiter ([Sagittarius](../01_Rasi/0109_Dhanu.mdx), [Pisces](../01_Rasi/0112_Meena.mdx)).

#### Nakshatras (Lunar Mansions) Ruled by Ketu
Ketu provides the spiritual, penetrating, and computational drive for three major Nakshatras:
1. **[Ashwini Nakshatra](../05_Nakshatra/0501_Ashwini.mdx):** The "Star of Transport" — Located in Aries, representing the swift onset of healing energy and the beginning of the soul's journey.
2. **[Magha Nakshatra](../05_Nakshatra/0510_Magha.mdx):** The "Star of Power" — Located in Leo, representing the ancestral lineage, traditional authority, and the seat of the pitrus.
3. **[Mula Nakshatra](../05_Nakshatra/0519_Mula.mdx):** The "Root Star" — Located in Sagittarius, representing the power to ruin or uproot in order to find the absolute truth and spiritual foundation.
...
**[Ketu Mahadasha](../04_DashaSystem/0401_Vimsottari_Dasha/040103_Vimsottari_Dasha_of_Ketu_7years.mdx):**
...
<FAQBlock faqs={[
  ...
  { "question": "How does Ketu influence spiritual awakening?", "answer": "Ketu's role is to detach the soul from material illusions. Its placement often indicates where an individual has already mastered material lessons in past lives and is now seeking spiritual depth." },
  { "question": "Can Ketu influence career success?", "answer": "Yes, it favors careers in deep research, mathematics, spirituality, alternative medicine, and positions that require intense focus or working in solitude." },
  { "question": "What health conditions are governed by Ketu?", "answer": "Ketu rules the nervous system and is associated with mysterious ailments, sudden accidents, and conditions that can be difficult for modern medicine to diagnose." },
  { "question": "Which planetary periods (Dashas) are most significant for Ketu?", "answer": "The 7-year [Ketu Mahadasha](../04_DashaSystem/0401_Vimsottari_Dasha/040103_Vimsottari_Dasha_of_Ketu_7years.mdx) is an intensive period for internal reflection, spiritual growth, and resolving dormant karmic patterns." },
  { "question": "What are the recommended Vedic remedies for Ketu?", "answer": "Remedies include worshipping Lord Ganesha, feeding street dogs, wearing a Cat's Eye (Lehsunia) gemstone, and donating multi-colored items to the needy." },
  { "question": "Which Nakshatras are ruled by Ketu?", "answer": "Ketu rules the three penetrating Nakshatras: Ashwini, Magha, and Mula. These stars focus on swift healing, ancestral connections, and uprooting illusions to find the root truth." },
  { "question": "Why is Ketu called the 'Moksha Karaka'?", "answer": "Because it is the ultimate significator of spiritual liberation, helping the soul break free from the cycle of desire (Rahu) and attain final enlightenment." }
]} />
