...
The messenger of the gods, Mercury, manages the flow of information and energy across specific sectors of the zodiac:

#### Zodiac Signs Governed by Mercury
- **Primary Rasi:** [Gemini (Mithuna)](../01_Rasi/0103_Mithuna.mdx) — The sign of versatile communication, networking, and the dual nature of the intellect.
- **Mooltrikona & High Dignity:** [Virgo (Kanya)](../01_Rasi/0106_Kanya.mdx) — The sign where Mercury reaches its highest exaltation, embodying analytical precision and service.
- **Debilitation:** [Pisces (Meena)](../01_Rasi/0112_Meena.mdx) — Mercury's logical and analytical nature is challenged by the vast, intuitive, and boundless ocean of Pisces.

#### Nakshatras (Lunar Mansions) Ruled by Mercury
Mercury governs three Nakshatras that conclude the three major "cycles" of the zodiac:
1. **[Ashlesha Nakshatra](../05_Nakshatra/0509_Ashlesha.mdx):** The "Clinging Star" — Located in Cancer, representing sharp observation, calculation, and deep psychological insight.
2. **[Jyeshtha Nakshatra](../05_Nakshatra/0518_Jyeshtha.mdx):** The "Elder Star" — Located in Scorpio, representing seniority, mastery, and the height of mental power.
3. **[Revati Nakshatra](../05_Nakshatra/0527_Revati.mdx):** The "Star of Wealth" — Located in Pisces, representing the final transition, infinite knowledge, and safe journeys.
...
**[Mercury Mahadasha](../04_DashaSystem/0401_Vimsottari_Dasha/040109_Vimsottari_Dasha_of_Budha_Mercury_17years.mdx):**
...
<FAQBlock faqs={[
  ...
  { "question": "Which Nakshatras are ruled by Mercury?", "answer": "Mercury rules the three highly intelligent and finalizing Nakshatras: Ashlesha, Jyeshtha, and Revati. These stars signify the completion of cycles and deep intellectual mastery." },
  { "question": "Why is Mercury called the 'Prince' among planets?", "answer": "Because it is youthful, adaptable, and takes on the character of the planets it is associated with, reflecting the curious and flexible nature of the intellect." }
]} />
